...
def train_one_epoch(model, 
    ...
    for _, (images, labels) in enumerate(metric_logger.log_every(data_loader, log_freq, header)):
        ...
        with torch.cuda.amp.autocast(fp16_scaler is not None):
            ...
            crossmodal_loss, idx_to_keep1_2, idx_to_keep2_1 = criterion_attn(attn_cfp, attn_oct, labels, epoch)
            x = model.forward_pool_head(attn_cfp, attn_oct, idx_to_keep1_2, idx_to_keep2_1)
